...
def main():
    ...
    p.add_argument("--threads", type=int, default=None, help="torch.set_num_threads on CPU")
    p.add_argument("--include_preproc", action="store_true", help="Measure preprocess + model")
    p.add_argument("--image", type=str, default=None, help="Optional image path to include real preprocess")
    args = p.parse_args()
